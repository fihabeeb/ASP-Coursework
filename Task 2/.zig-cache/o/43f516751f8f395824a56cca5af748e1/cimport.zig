...
pub const struct_Context = extern struct {
    ...
    r14: ?*anyopaque = null,
    r15: ?*anyopaque = null,
    pub const context = get_context;
    pub const context1 = set_context;
    pub const context2 = swap_context;
};
pub extern fn get_context(c: [*c]struct_Context) c_int;
pub extern fn set_context(c: [*c]struct_Context) void;
pub extern fn swap_context(out: [*c]struct_Context, in: [*c]struct_Context) void;
...
pub const __INTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `L`"); // <builtin>:145:9
pub const __UINTMAX_TYPE__ = c_ulong;
pub const __UINTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `UL`"); // <builtin>:147:9
...
pub const __UINT32_FMTX__ = "X";
pub const __UINT32_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `U`"); // <builtin>:190:9
...
pub const __UINT64_FMTX__ = "lX";
pub const __UINT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `UL`"); // <builtin>:198:9
